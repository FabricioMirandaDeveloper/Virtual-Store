  ...
  <>
    <header>
      <div className={style["headerContainer"]}>
        <a href="./index.html" className={style["headerLogo"]}>
          <img
        ...
        <ul className={style["headerSocial"]}>
          <li id="facebook" className={style["headerLi"]}>
            <a className={style["headerA"]} href="https://facebook.com">
              <img
                className={style["headerSocialImg"]}
          ...
          <li id="instagram" className={style["headerLi"]}>
            <a className={style["headerA"]} href="https://instagram.com">
              <img
                className={style["headerSocialImg"]}
          ...
          <li id="cart" className={style["headerLi"]}>
            <a className={style["headerA"]} href="./cart.html">
              <img
                className={style["headerSocialImg"]}
